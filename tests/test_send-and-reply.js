describe('structuredChannel.send()', function () {
  ...
  it(
    'should resolve once the remote replies',
  ...
  it(
    'should resolve once remote sends an async reply',
    genericTest(function (channel) {
  ...
  it(
    'should reject if remote handlers rejects',
    genericTest(function (channel) {
  ...
  it(
    'should reject if remote handlers throws synchronously',
    genericTest(function (channel) {
  ...
  it(
    'should reject if there is no handler for the message',
    genericTest(function (channel) {
  ...
  it(
    'should reject if the request payload cannot be cloned',
    genericTest(function (channel) {
  ...
  it(
    'should map replies to correct requests',
    genericTest(function (channel) {
  ...
  it(
    'should map replies to correct requests of same type',
    genericTest(function (channel) {
      // Async ping is sent first, the reply should come after the sync one.
